...
white_race_map <- HTML('<a href="https://ibb.co/f2f4kH6"><img src="https://i.ibb.co/mGk694Z/white.png" alt="white" border="0"></a>')
```
...
#    menuItem("History of the Valley", tabName = "history", icon = icon("book")),
   ...
   menuItem("History of the Valley", tabName = "history", icon = icon("book"),
    ...
    menuItem("Overview Charts", icon = icon("chart-bar"), tabName = "charts"),
...
body <- dashboardBody(
  ...
  # start map - wip
    tabItem(tabName = "map", h1("Overview Map"), lead_text, lead_map, pediatric_text, pediatric_map, hospitalization_text, hospitalization_map, child_text, child_map, household_text, household_map, diversity_text, diversity_map, white_race_map, map_box),
  # end map - wip 
