...
body <- dashboardBody(
  ...
  # start map - wip
    tabItem(tabName = "map", h1("Overview Map"), lead_text, lead_map, pediatric_text, pediatric_map, hospitalization_text, hospitalization_map, child_text, child_map, household_text, household_map, diversity_text, diversity_map, map_box),
  # end map - wip 
